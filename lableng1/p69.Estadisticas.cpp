...
int menu() {
	...
	system("cls");
	printf("--------------------------------------------------\n");
	printf("Cálculos estadísticos sobre un arreglo de números \n");
	printf("--------------------------------------------------\n");
	printf("Leer los elementos del arreglo ............... [1]\n");
	printf("Mostrar los elementos en el arreglo .......... [2]\n");
	printf("Calcular y mostrar estadísticas .............. [3]\n");
	printf("Salir ...................................... [4]..\n");
	...
	do {
		...
		switch(op) {
			...
			case 2:	printf("Mostrando los elementos en el arreglo\n");
					mostrararreglo(A, n);
					break;
			case 3:	printf("Calculando estadísticas en base a los numeros en el arreglos\n\n");
					may = mayor(A, n);
					men = menor(A, n);
					med = media(A, n);
					...
					printf("La desviación estandar es                  %.2lf\n", des);
					break;
